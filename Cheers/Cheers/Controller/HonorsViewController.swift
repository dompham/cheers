...
class HonorsViewController : UIViewController, MDCTabBarDelegate {
    ...
    func setupSlider1(){
        ...
        slider1.trackBackgroundColor = lightCheersBlue;
        slider1.color = cheersOrange
    ...
    func assembleViews(){
        ...
        slider1.snp.makeConstraints { (makeSlider) in
            makeSlider.top.equalTo(styleField.snp.bottom).offset(30)
